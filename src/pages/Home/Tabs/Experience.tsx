...
const jobs = [
  {
    ...
    company: 'РСХБ-Интех',
    department: 'ЦК фронт-энд разработки',
    period: '08.2024 - по н.в.',
    description: `<ul>
        <li>* Разработка веб-модулей (МС "Лояльность", "CRM", "Партнеры") для мобильного приложения, с применением библиотек React/Redux/Typescript.</li>
        <li>* Разработка конструктора сайтов с использованием библиотек VUE3/Nuxt.</li>
        <li>* Daily/Retro c владельцем продукта.</li>
      </ul>`,
  },
  {
    id: 2,
    position: 'Frontend-разработчик',
    company: 'Сбербанк',
    department: 'Центр управления местами размещения',
    period: '02.2022 - 05.2024',
    description: `<ul>
        <li>* Разработка пользовательских интерфейсов, отдельных UI компонентов с применением библиотек React/Redux/Typescript.</li>
        <li>* Daily/Retro c владельцем продукта.</li>
